...
<template>
	<view class="photographBody" >
		...
		<!-- :style="{left:style.left, top:style.top}" -->
		<view class="photograph" @click="photograph" v-if="showPhotograph2" hover-class="photograph_hover"></view>
...
.photographBody{
	...
	.imgbox{
		...
		// max-height: 348.66rpx;
		height: auto;
		
		display: grid;
		grid-template-columns: repeat(3,1fr);
		// 有多余数据时，自动添加新行时默认行高为：173.33rpx
		grid-auto-rows: 173.33rpx ;
		text-align: center;
